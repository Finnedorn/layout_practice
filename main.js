    ...
    fetch('data.json') // Assicurati che il percorso sia corretto
      ...
      .then(plates => {
        ...
        plates.forEach((plate) => {
          ...
          plateElement.classList.add("card", "col-4", "border-0", "position-relative", "pb-2", "bg-my-primary");
          ...
          <div class="position-relative pb-3">
              <div class="position-absolute d-flex justify-content-center add-to-cart">
